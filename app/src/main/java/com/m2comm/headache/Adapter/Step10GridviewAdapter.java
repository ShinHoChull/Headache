...
public class Step10GridviewAdapter extends BaseAdapter {

    ArrayList<Step10EtcDTO> arrayList;
    LayoutInflater inflater;

    public Step10GridviewAdapter(ArrayList<Step10EtcDTO> arrayList, LayoutInflater inflater) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ( convertView == null ) {
            Step10EtcDTO row = this.arrayList.get(position);
