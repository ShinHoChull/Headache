...
public class Step7GridviewAdapter extends BaseAdapter {

    ArrayList<Step7EtcDTO> arrayList;
    LayoutInflater inflater;

    public Step7GridviewAdapter(ArrayList<Step7EtcDTO> arrayList, LayoutInflater inflater) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Step7EtcDTO row = this.arrayList.get(position);
