...
public class Step8GridviewAdapter extends BaseAdapter {

    ArrayList<Step8EtcDTO> arrayList;
    LayoutInflater inflater;

    public Step8GridviewAdapter(ArrayList<Step8EtcDTO> arrayList, LayoutInflater inflater) {
