...
public class Step5GridviewAdapter extends BaseAdapter {

    ArrayList<Step5EtcDTO> arrayList;
    LayoutInflater inflater;

    public Step5GridviewAdapter(ArrayList<Step5EtcDTO> arrayList, LayoutInflater inflater) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Step5EtcDTO row = this.arrayList.get(position);
