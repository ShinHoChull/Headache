...
public class Step10EtcDTO {
    ...
    public Step10EtcDTO(int default_icon, int click_icon, String content, Boolean etc, Boolean etcBt, Boolean isClick, int key, String val) {
